...
@section('title', 'Aquaserv - PDD')

@section('page_hero')
    <h1><i class="bi bi-file-earmark-text me-2"></i> Aquaserv - PDD</h1>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item"><a href="{{ url('/') }}">Acasă</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/despre') }}">Despre noi</a></li>
            <li class="breadcrumb-item active">PDD</li>
        </ol>
    </nav>
@endsection
...
<style>
    @media (max-width: 575.98px) {
        ...
        /* Indicatori suplimentari — randuri mai compacte */
        .pdd-indicatori-supl .col-md-6 > div { font-size: 0.8rem; padding: 0.6rem 0.75rem !important; }

        /* Document original — stivuit pe ecran foarte ingust */
        .pdd-doc-card { flex-wrap: wrap; }
        .pdd-doc-text { flex-basis: 100%; order: 2; margin-top: 0.5rem; }
        .pdd-doc-btn { order: 3; width: 100%; }
    }
</style>
@endpush
@endsection
