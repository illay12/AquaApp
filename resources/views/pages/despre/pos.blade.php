            ...
            <div class="accordion" id="accordionCL">
                ...
                <div class="accordion-item mb-3" style="border-radius:12px!important;overflow:hidden;border:none;box-shadow:0 2px 16px rgba(0,119,182,0.09);">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#cl7"
                            ...
                            Reabilitarea și extinderea rețelelor de distribuție și canalizare — Tulcea Lot 2
                        </button>
                    </h2>
                    <div id="cl7" class="accordion-collapse collapse" data-bs-parent="#accordionCL">
                        <div class="accordion-body" style="background:#fff;font-size:0.875rem;color:#374151;line-height:1.8;">
                            <div class="row g-3 mb-3">
                                <div class="col-md-4"><div style="background:#f0f8ff;border-radius:10px;padding:0.75rem 1rem;"><div style="font-size:0.7rem;font-weight:700;color:#64748b;text-transform:uppercase;">Valoare la atribuire</div><div style="font-weight:700;color:var(--aqua-dark);">24.530.354,25 lei fără TVA</div></div></div>
                                <div class="col-md-4"><div style="background:#f0f8ff;border-radius:10px;padding:0.75rem 1rem;"><div style="font-size:0.7rem;font-weight:700;color:#64748b;text-transform:uppercase;">Valoare după acte adiționale</div><div style="font-weight:700;color:var(--aqua-dark);">26.907.498,45 lei fără TVA</div></div></div>
                                <div class="col-md-4"><div style="background:#fff3cd;border-radius:10px;padding:0.75rem 1rem;"><div style="font-size:0.7rem;font-weight:700;color:#64748b;text-transform:uppercase;">Valoare plătită cu actualizare</div><div style="font-weight:700;color:#b45309;">17.147.827,82 lei fără TVA</div></div></div>
                            </div>
                            <div class="mb-2 p-2" style="background:#fff3cd;border-radius:8px;font-size:0.8rem;color:#92400e;">
                                <i class="bi bi-exclamation-triangle-fill me-1"></i> <strong>Contract reziliat și fazat</strong> — indicatorii fizici receptionați în POIM
                            </div>
                            <p><strong>Antreprenor:</strong> SC VILCEANA S.R.L. Galați</p>
                            <p><strong>Obiectiv:</strong> Reabilitarea și extinderea sistemului de distribuție apă potabilă (~53,5 km) și a sistemului de canalizare (~60 km) în Tulcea.</p>
                            <div class="row g-3 mt-1">
                                <div class="col-md-6">
                                    <p class="fw-bold mb-1" style="color:var(--aqua-dark);">Indicatori apă</p>
                                    <ul style="margin:0;padding-left:1.25rem;">
                ...
                <div class="accordion-item mb-3" style="border-radius:12px!important;overflow:hidden;border:none;box-shadow:0 2px 16px rgba(0,119,182,0.09);">
                    ...
                    <div id="cl10" class="accordion-collapse collapse" data-bs-parent="#accordionCL">
                        <div class="accordion-body" style="background:#fff;font-size:0.875rem;color:#374151;line-height:1.8;">
                            <div class="row g-3 mb-3">
                                <div class="col-md-4"><div style="background:#f0f8ff;border-radius:10px;padding:0.75rem 1rem;"><div style="font-size:0.7rem;font-weight:700;color:#64748b;text-transform:uppercase;">Valoare la atribuire</div><div style="font-weight:700;color:var(--aqua-dark);">23.895.934,10 lei fără TVA</div></div></div>
                                <div class="col-md-4"><div style="background:#f0f8ff;border-radius:10px;padding:0.75rem 1rem;"><div style="font-size:0.7rem;font-weight:700;color:#64748b;text-transform:uppercase;">Valoare după acte adiționale</div><div style="font-weight:700;color:var(--aqua-dark);">25.014.164,72 lei fără TVA</div></div></div>
                                <div class="col-md-4"><div style="background:#fff3cd;border-radius:10px;padding:0.75rem 1rem;"><div style="font-size:0.7rem;font-weight:700;color:#64748b;text-transform:uppercase;">Valoare plătită cu actualizare</div><div style="font-weight:700;color:#b45309;">17.348.979,02 lei fără TVA</div></div></div>
                            </div>
                            <div class="mb-2 p-2" style="background:#fff3cd;border-radius:8px;font-size:0.8rem;color:#92400e;">
                                <i class="bi bi-exclamation-triangle-fill me-1"></i> <strong>Contract reziliat și fazat</strong> — indicatorii fizici receptionați în POIM
                            </div>
                            ...
                            <div class="row g-3 mt-1">
                                <div class="col-md-6">
                                    <p class="fw-bold mb-1" style="color:var(--aqua-dark);">Mãcin — Indicatori apă</p>
                                    <ul style="margin:0;padding-left:1.25rem;">
                                        <li>Reabilitare rețele distribuție: 12,6 km</li>
                                        <li>Extindere rețele distribuție: 4,0 km</li>
                                        <li>Instalare contoare: 1.192 buc.</li>
                                    </ul>
                                    <p class="fw-bold mt-2 mb-1" style="color:var(--aqua-dark);">Mãcin — Indicatori ape uzate</p>
                                    <ul style="margin:0;padding-left:1.25rem;">
                                        <li>Reabilitare rețele canalizare: 1,9 km</li>
                                        <li>Extindere rețele canalizare: 13,2 km</li>
                                        <li>Stații pompare noi: 1 buc.</li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
                                    <p class="fw-bold mb-1" style="color:var(--aqua-dark);">Isaccea — Indicatori apă</p>
                                    <ul style="margin:0;padding-left:1.25rem;">
                                        <li>Reabilitare rețele distribuție: 7,0 km</li>
                                        <li>Extindere rețele distribuție: 5,9 km</li>
                                        <li>Instalare contoare: 547 buc.</li>
                                    </ul>
                                    <p class="fw-bold mt-2 mb-1" style="color:var(--aqua-dark);">Isaccea — Indicatori ape uzate</p>
                                    <ul style="margin:0;padding-left:1.25rem;">
                                        <li>Reabilitare rețele canalizare: 1,4 km</li>
                                        <li>Extindere rețele canalizare: 9,6 km</li>
                                        <li>Stații pompare noi: 1 buc.</li>
                                    </ul>
                                </div>
                            </div>
