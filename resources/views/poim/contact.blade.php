...
<section style="padding:2.5rem 0 4rem;">
    <div class="container">
        <div class="row g-4">
            <div class="col-md-6">
                <div class="h-100 p-4" style="background:#fff;border-radius:16px;box-shadow:0 4px 24px rgba(61, 143, 135,0.08);">
                    ...
                    <ul style="list-style:none;padding:0;margin:0;">
                        <li class="d-flex gap-3 mb-3">
                            ...
                            <span style="font-size:0.92rem;color:#4a4a4a;">Str. Rezervorului, nr. 2, Tulcea <br><span class="text-muted" style="font-size:0.8rem;">(avize și autorizații, reclamații)</span></span>
                        </li>
                        <li class="d-flex gap-3 mb-3">
                            <i class="bi bi-telephone-fill" style="color:var(--aqua-primary);font-size:1.1rem;"></i>
                            <span style="font-size:0.92rem;color:#4a4a4a;">Telefon / Fax: 0240.524.310</span>
                        </li>
                        <li class="d-flex gap-3 mb-3">
                            <i class="bi bi-headset" style="color:var(--aqua-primary);font-size:1.1rem;"></i>
                            <span style="font-size:0.92rem;color:#4a4a4a;">Telefon dispecerat: 0747.022.009</span>
                        </li>
                        <li class="d-flex gap-3 mb-3">
                            <i class="bi bi-envelope-fill" style="color:var(--aqua-primary);font-size:1.1rem;"></i>
                            <span style="font-size:0.92rem;color:#4a4a4a;">secretariat@aquaservtulcea.ro</span>
                        </li>
            ...
            <div class="col-md-6">
                <div class="h-100 p-4" style="background:linear-gradient(135deg,#002756,#3d8f87,#76b1a8);border-radius:16px;color:#fff;">
