                    ...
                    <table class="table table-bordered table-stack-sm mb-0" style="font-size:0.875rem;">
                        <tbody>
                            ...
                            <tr style="background:#f8fafc;">
                                ...
                                <td class="px-4 py-3"><strong style="color:var(--aqua-primary);">RSO 2.5</strong> - Promovarea accesului la apă și o gospodărire sustenabilă a apelor</td>
                            </tr>
                            <tr>
