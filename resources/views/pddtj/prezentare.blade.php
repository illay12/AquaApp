        ...
        <div class="mb-2">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4 col-sm-6">
                    <a href="{{ route($link['route']) }}" class="d-block h-100 text-decoration-none" style="background:#fff;border-radius:14px;padding:1.5rem;box-shadow:0 4px 24px rgba(0,119,182,0.08);border:1.5px solid var(--aqua-border);transition:all .2s;">
