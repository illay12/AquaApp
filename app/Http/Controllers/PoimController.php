...
class PoimController extends Controller
{
    /**
    ...
    {
        return view('poim.prezentare');
    }

    /**
     * Prezentare » Despre POIM
     * GET /prezentare/despre-poim
     */
    public function desprePoim()
    {
        return view('poim.despre-poim');
    }
    ...
    {
        return view('poim.despre-proiect');
    }

    /**
     * Listă contracte proiect (18 de lucrări, 1 de furnizare, 3 de servicii —
     * doar cele semnate au pagină de detaliu proprie)
     * GET /contracte
     */
    public function contracte()
    {
        ...
        return view('poim.contracte', $data);
    }
        ...
        foreach ($tipuri as $tip) {
            foreach ($tip['lista'] as $contract) {
                if (strtolower($contract['cod']) === strtolower($cod)) {
                    return view('poim.contract-detaliu', [
                        'contract' => $contract,
                        'tipLabel' => $tip['label'],
                    ]);
                }
    ...
    /**
     * Datele contractelor POIM cu pagină de detaliu (Lucrări / Servicii / Furnizare),
     * preluate de pe microsite-ul WordPress original (poim.aquaservtulcea.ro).
     * Restul contractelor din program (CL-2, CL-3, CL-5…CL-18, CF-1, CS-3) apar
     * doar în listă (pagina „Contracte”), fără pagină de detaliu proprie —
     * la fel ca pe site-ul sursă.
     */
    private function contracteData(): array
    {
        $lucrariToateCodurile = [
            'CL-1'  => 'Reabilitarea captărilor din Tulcea și Mahmudia',
            'CL-2'  => 'Extinderea și reabilitarea stațiilor de tratare și complexelor de înmagazinare-pompare din Tulcea și Mahmudia',
            'CL-3'  => 'Extinderea și reabilitarea captărilor, stațiilor de tratare și complexelor de înmagazinare-pompare din Isaccea și Văcăreni',
            'CL-4'  => 'Extinderea și reabilitarea captărilor, stațiilor de tratare și complexelor de înmagazinare-pompare din Carcaliu și Babadag',
            'CL-5'  => 'Extinderea și reabilitarea captărilor, stațiilor de tratare și complexelor de înmagazinare-pompare din Chilia Veche, Pardina, Ceatalchioi, C.A. Rosetti și Sulina — Lot 1: Chilia Veche, Pardina și Ceatalchioi · Lot 2: C.A. Rosetti și Sulina',
            'CL-6'  => 'Extinderea și reabilitarea captărilor, stațiilor de tratare și complexelor de înmagazinare-pompare din Crișan, Caraorman, Mila 23, Maliuc, Partizani și Gorgova',
            'CL-7'  => 'Extindere și reabilitare stații de epurare în Tulcea și Mahmudia',
            'CL-8'  => 'Stație nouă de epurare în localitatea Chilia Veche. Extindere (completare) stație de epurare în Sulina',
            'CL-9'  => 'Stație nouă de epurare în localitatea Văcăreni. Extindere și reabilitare stații de epurare în Babadag, Isaccea, Măcin și Carcaliu',
            ...
            'CL-11' => 'Extinderea și reabilitarea sistemului de alimentare cu apă și a sistemului de colectare a apelor uzate menajere din Tulcea (zonele sud și vest)',
            'CL-12' => 'Extinderea și reabilitarea sistemului de alimentare cu apă și a sistemului de colectare a apelor uzate menajere din Mineri',
            'CL-13' => 'Extinderea și reabilitarea sistemului de alimentare cu apă și a sistemului de colectare a apelor uzate menajere din Babadag',
            'CL-14' => 'Extinderea și reabilitarea sistemelor de alimentare cu apă și a sistemelor de colectare a apelor uzate menajere din Isaccea, Măcin și Mahmudia — Lot 1: Isaccea · Lot 2: Măcin · Lot 3: Mahmudia',
            'CL-15' => 'Extinderea și reabilitarea sistemelor de alimentare cu apă din Văcăreni și Carcaliu. Înființarea sistemului de colectare a apelor uzate menajere în Văcăreni',
            'CL-16' => 'Extinderea și reabilitarea sistemului de alimentare cu apă și a sistemului de colectare a apelor uzate menajere din Chilia Veche. Extinderea și reabilitarea sistemului de alimentare cu apă din Pardina',
            'CL-17' => 'Extinderea și reabilitarea sistemelor de alimentare cu apă din Sulina și C.A. Rosetti. Extinderea și reabilitarea sistemului de colectare a apelor uzate menajere din Sulina',
            'CL-18' => 'Extinderea și reabilitarea sistemelor de alimentare cu apă din Ceatalchioi, Crișan, Caraorman, Maliuc, Partizani, Ilgani, Mila 23, Gorgova',
        ];

        // Pe pagina „Contracte" a site-ului sursă, sub „Contract de furnizare" apare
        // doar CF-1 — CF-2 nu e listat acolo, deși are propria pagină de detaliu
        // (accesibilă din meniu și din comunicate). Păstrăm aceeași listare aici.
        $furnizareToateCodurile = [
            'CF-1' => 'Furnizare de utilaje, echipamente și dotări pentru operarea infrastructurii de apă și apă uzată realizată prin Proiect',
        ];

        $serviciiToateCodurile = [
            'CS-1' => 'Asistență tehnică și supervizare, inclusiv publicitate',
            'CS-2' => 'Servicii de audit pentru Proiect',
            'CS-3' => 'Asistență tehnică din partea proiectantului, conform Legii 10/1995, în perioada de execuție a lucrărilor',
        ];
        ...
        $lucrari = [
            ...
            [
                ...
                'documente' => [
                    ['titlu' => 'Autorizație de construire nr. 93 din 22.06.2023', 'fisier' => 'contracte/autorizatie-construire-93.pdf'],
                ],
        ...
        $furnizare = [
            [
                ...
                'documente' => [
                    ['titlu' => 'Ordin de începere a Contractului de Furnizare 14221/28.11.2023', 'fisier' => 'contracte/ordin-inceperecf2.pdf'],
                    ['titlu' => 'Proces verbal de recepție calitativă-cantitativă – 18.12.2023', 'fisier' => 'contracte/pv-receptie-cf2.pdf'],
                ],
                'status' => 'Finalizat (18.12.2023)',
            ],
        ];

        return compact('lucrari', 'servicii', 'furnizare', 'lucrariToateCodurile', 'furnizareToateCodurile', 'serviciiToateCodurile');
    }
    ...
    public function comunicare()
    {
        ...
        return view('poim.comunicare', compact('comunicate'));
    }
    ...
    {
        $basePath = storage_path('app/public/galerie/poim');

        $galerii = [];
        foreach (PoimAdminController::categoriiGalerie() as $cod => $titlu) {
        ...
        return view('poim.galerie', compact('galerii'));
    }
